          ...
          <ul className="navbar-nav ms-auto align-items-center" style={{ gap: 0 }}>
            ...
            <li className="nav-item dropdown me-2">
              ...
              <ul className="dropdown-menu" aria-labelledby="resourcesDropdown" style={{ border: '1.5px solid #09b44d', borderRadius: 12, boxShadow: '0 4px 18px rgba(9,180,77,0.07)', minWidth: 230, marginTop: 6, padding: '0.5rem 0' }}>
                <li><Link className="dropdown-item d-flex align-items-center px-3 py-2" href="/structured-settlement-info-hub" style={{ fontSize: '1.07rem', gap: 10, borderRadius: 6, fontWeight: 500 }} onClick={() => setNavbarCollapsed(true)}><span style={{fontSize: '1.15em'}}>📚</span>Knowledge Hub</Link></li>
                ...
                <li><Link className="dropdown-item d-flex align-items-center px-3 py-2" href="/resources" style={{ fontSize: '1.07rem', gap: 10, borderRadius: 6, fontWeight: 500 }} onClick={() => setNavbarCollapsed(true)}><span style={{fontSize: '1.15em'}}>📚</span>Insurance Companies</Link></li>
                <li><Link className="dropdown-item d-flex align-items-center px-3 py-2" href="/structured-settlement-laws" style={{ fontSize: '1.07rem', gap: 10, borderRadius: 6, fontWeight: 500 }} onClick={() => setNavbarCollapsed(true)}><span style={{fontSize: '1.15em'}}>⚖️</span>Federal Law</Link></li>
                <li><Link className="dropdown-item d-flex align-items-center px-3 py-2" href="/structured-settlement-laws-by-state" style={{ fontSize: '1.07rem', gap: 10, borderRadius: 6, fontWeight: 500 }} onClick={() => setNavbarCollapsed(true)}><span style={{fontSize: '1.15em'}}>🏛️</span>Laws by State</Link></li>
              </ul>
            </li>
